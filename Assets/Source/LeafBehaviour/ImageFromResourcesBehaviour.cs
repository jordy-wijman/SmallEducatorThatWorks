...
namespace Source.LeafBehaviour
{
    ...
    {
        public ImageFromResourcesBehaviour(SmallEducator smallEducator, string path, GameObject quad, Vector2 position,
            Texture2D tex, float timer) : base(smallEducator, path, quad, position, tex, timer)
        {
        }
